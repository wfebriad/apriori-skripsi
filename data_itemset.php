...
//                    ('2016-06-01', 'sweety FP XL34')
    ...
    ?>
    <script> location.replace("?menu=data_itemset&pesan_success=Data berhasil disimpan"); </script>
    <?php
}
...
if (isset($_GET['delete'])) {
    ...
    $db_object->db_query($sql);
    ?>
    <script> alert('Data transaksi berhasil dihapus'); location.replace("?menu=data_itemset"); </script>
    <?php
}
...
if (isset($_GET['tambah_produk'])) {
    ...
    ?>
    <script> alert('Data berhasil disimpan'); location.replace("?menu=data_itemset"); </script>
<?php } ?>
<!---->
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <form method="post" enctype="multipart/form-data"
                              action="index.php?menu=data_itemset&tambah_produk=yes">
