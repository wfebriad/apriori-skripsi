...
//                    ('2016-06-01', 'sweety FP XL34')
    ...
    ?>
    <script> location.replace("?menu=data_rekam_medis&pesan_success=Data berhasil disimpan"); </script>
    <?php
}
...
if (isset($_POST['delete'])) {
    ...
    $db_object->db_query($sql);
    ?>
    <script> location.replace("?menu=data_rekam_medis&pesan_success=Data transaksi berhasil dihapus"); </script>
    <?php
}
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form method="post" enctype="multipart/form-data"
                              action="index.php?menu=data_rekam_medis&tambah_transaksi=yes">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <label>Data Riwayat Rekam Medis Pasien</label><br/>
                                        <?php
                                        ...
                                        while ($baris = $db_object->db_fetch_array($itemset_result)) {
                                            ...
                                            <div class="col-md-4">
                                                <input name="nama_itemset[]" value="<?= $baris['nama_itemset'] ?>"
                                                       type="checkbox"> <?= $baris['nama_itemset'] ?>
                                            </div>
                                        <?php } ?>
                                    </div>
                                </div>
